...
AutomationML files are xml based files. There is an editor to help with the visualization of the files that can be downloaded from: https://www.automationml.org/download-archive/.
